  ...
  return (
    <div className='w-dwh h-dvh bg-main-light flex items-center justify-center z-50 dark:bg-main-dark'>
      ...
      <div className='absolute inset-0 overflow-hidden'>
        <div className='absolute top-20 left-20 w-32 h-32 bg-bakery-200/30 rounded-full blur-3xl animate-pulse' />
        <div
          className='absolute bottom-32 right-32 w-40 h-40 bg-cream-200/30 rounded-full blur-2xl animate-pulse'
          style={{ animationDelay: '1s' }}
        />
        <div className='absolute top-1/2 left-1/3 w-24 h-24 bg-bakery-300/20 rounded-full blur-xl animate-float' />
      </div>
      ...
      <div className='text-center z-10'>
        ...
        <div className='flex justify-center space-x-2'>
          {[0, 1, 2].map(i => (
            <div
              key={i}
              className='w-3 h-3 bg-bakery-500 rounded-full animate-bounce'
        ...
        <div className='mt-8 w-64 mx-auto'>
          <div className='bg-gray-200 dark:bg-gray-700 rounded-full h-2 overflow-hidden'>
            <div className='bg-gradient-to-r from-bakery-500 to-cream-500 h-full rounded-full animate-pulse w-full transition-all duration-1000' />
          </div>
        </div>
