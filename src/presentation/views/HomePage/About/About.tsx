...
export function About({
  ...
  const footer = getTranslation(footerContent?.cms_content_translations, lang);

  const sectionTitle = intro?.title || t('about.title');
  const sectionDescription = intro?.body || t('about.description');
  const footerText = footer?.body || t('about.footer');
  ...
  return (
    <section id='about' className='relative min-h-dvh w-full pt-24'>
      ...
      <div className='relative z-10 w-full'>
            ...
            <div className='mx-12 relative overflow-x-hidden'>
              ...
              >
                {timelineEvents.map((event, index) => {
                  const tr = getTranslation(event.timeline_event_translations, lang);
                    ...
                    >
                      ...
                      >
                        <figure className='max-w-3xs'>
                          <Image
                            src={event.image_url || MyBakeryImage}
                            alt={tr?.title || ''}
                            width={300}
                            height={200}
        ...
        {featureCards.length > 0 && (
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
            {featureCards.map(feature => {
              const tr = getTranslation(feature.feature_card_translations, lang);
              const IconComponent = iconMap[feature.icon || ''] || HeartIcon;
        ...
        {/* Bottom Description */}
        <div className='text-center mt-16 flex flex-col gap-6'>
