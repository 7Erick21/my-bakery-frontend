...
export const DashboardLayout: FC<DashboardLayoutProps> = ({ userRole, children }) => {
  ...
  return (
    <div
      className='min-h-dvh flex flex-col bg-white bg-linear-to-br from-amber-50/80 via-orange-50/90 to-pink-50/80 dark:bg-gray-900 dark:from-amber-950/30 dark:via-orange-950/20 dark:to-pink-950/30'
    ...
    >
      ...
      >
        ...
        <button
          ...
          className='md:hidden flex items-center justify-center w-9 h-9 -ml-1 rounded-lg hover:bg-amber-50/60 dark:hover:bg-amber-900/15 transition-colors cursor-pointer'
        ...
        {/* Dashboard label */}
        <span className='hidden md:inline text-xs font-medium text-amber-600/80 dark:text-amber-400/70 uppercase tracking-wider'>
          Dashboard
        </span>
